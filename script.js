...
// for toggle header and menu
  ...
  const projects = [
    {
      ...
      description: 'This Stats Preview Card design presents business intelligence in a clean, modern layout, ideal for SaaS platforms, dashboards, and marketing landing pages. It effectively blends visual storytelling with informative statistics to showcase data that drives decisions.',
      ...
      descriptionFeatures: [
        ...
        { 
           title: 'Business Metrics at a Glance:',
           matrix: [
            '10k+ Companies',
            '314 Templates',
            '12M+ Queries'],
    ...
    },
    {
      ...
      descriptionLast:'Designed with a sleek aesthetic, soft color palette, and custom illustrations, this layout enhances credibility while encouraging user interaction.',
    ...
    },
    {
      ...
      description: 'This modern grid-style dashboard design showcases an intuitive and vibrant interface for managing social media content using AI. It uses a bento-grid layout with eye-catching colors (lavender, purple, yellow, and cream) to present key features in an engaging way.',
      ...
      descriptionLast: 'With bold typography, minimal icons, and focused messaging, this layout delivers an engaging user experience — perfect for startups or SaaS tools aiming to boost productivity, growth, and engagement across social platforms.',
    ...
    },
    {
      ...
      description: 'This landing page design introduces Clipboard, a seamless cloud-based clipboard manager for macOS and iOS. The layout is clean, minimal, and user-centric, with smooth visual hierarchy and soft gradients that emphasize trust and usability.',
      ...
      descriptionLast: 'This landing page is ideal for showcasing SaaS products or tools that focus on productivity, efficiency, and user experience.', 
    ...
    },
    {
      ...
      description: "This beautifully designed results summary card presents a user's test performance in a modern, user-friendly interface. The layout is divided into two distinct sections:",
      descriptionMiddle: "Key Feature",
      descriptionLeftPanel: "Left Panel (Score Highlight):",
      descriptionFeatures : [ 'Displays the overall score (76/100) with a vibrant gradient background.',
      ...
      descriptionLast: "The design uses soft shadows, rounded corners, and subtle color contrasts to enhance clarity and elegance. Ideal for dashboards, ed-tech platforms, or productivity apps with performance tracking features.",
    ...
    },
    {
      ...
      description: 'notNotion is a simple and efficient task manager web app that lets you manage and search your pending tasks with ease. With a clean and responsive UI, users can quickly add, search, and delete tasks in just a few clicks.',
      descriptionMiddle: 'Key Features:',
      descriptionFeatures: [
      ...
      descriptionLast: 'Built with HTML, CSS, and JavaScript, this app is lightweight and perfect for practicing DOM manipulation and local state management.',
    ...
    {
      title: 'quiz app',
      description: 'notNotion - JavaScript Quiz App is a simple, interactive web application designed to test and strengthen your foundational JavaScript knowledge. Users can answer multiple-choice questions and submit their answers to practice and learn JavaScript basics.',
      descriptionMiddle: 'Key Features:',
      descriptionFeatures : [
      ...
      descriptionLast: 'This quiz interface is built with HTML and CSS, and it is ready for JavaScript logic integration for answer validation, scoring, and feedback. A perfect starter project for anyone learning DOM manipulation and form handling.',
    ...
    },
    {
      ...
      description: 'notNotion - Budget Tracker App is a clean, user-friendly web application that helps users manage their personal finances by tracking income and expenses in real-time.',
      descriptionMiddle: 'Features:',
      descriptionFeatures: [
      ...
      descriptionLast: 'Built using HTML and CSS, this app is ready for JavaScript integration to handle dynamic functionalities such as adding, calculating, storing, and deleting transactions.',
    ...
    },
    {
      ...
      description: 'This Blog Preview Card is a clean and visually striking UI component designed to showcase article summaries in a compact, mobile-friendly format. Inspired by modern design trends, the card uses strong contrast, bold typography, and a minimal layout to create an engaging user experience.',
      descriptionMiddle: 'Key Features:',
      descriptionFeatures: [
      ...
      descriptionLast: 'This layout is ideal for blog listings, educational sites, or news feeds. Built with HTML and CSS, it is perfect for enhancement with JavaScript or CMS integration for dynamic content.',
    ...
    },
    {
      ...
      description: "This Social Link Card is a sleek, minimal web component designed to display a user's online presence in one centralized place. Built with a dark theme, the design ensures a modern and professional look suitable for portfolios, link-in-bio pages, or developer profiles.",
      descriptionMiddle: "Key Features:",
      descriptionFeatures: [
      ...
      descriptionLast: 'This component is ideal for developers, content creators, and professionals who want to share all their key links through a single compact interface.',
    ...
    {
      title: 'recipe page',
      description: 'This Recipe Card Web Design presents a visually appealing and user-friendly layout for showcasing culinary content. Focused on readability and clarity, the card is ideal for food bloggers, cooking apps, or digital recipe books.',
      descriptionMiddle: 'Key Features:',
      descriptionFeatures: [
      ...
      descriptionLast: 'Perfect for creating a smooth cooking experience, this design balances aesthetic appeal with functional clarity.',
  ...
  projects.forEach(project =>{
    ...
    if(project.descriptionFeatures && Array.isArray(project.descriptionFeatures)){
      descriptionUl = document.createElement('ul');
      project.descriptionFeatures.forEach(feature =>{
        const descriptionLi = document.createElement('li');
        descriptionLi.textContent = feature;
        descriptionLi.className = 'description-list';
    ...
    informationViewButton.addEventListener('click',() =>{
      if(descriptionUl){
         ...
         informationViewButton.textContent = isHidden ? hideDetails :'View More'
        }
    });
